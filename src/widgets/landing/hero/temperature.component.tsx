...
const TemperatureComponent = () => {
  ...
  return (
    <button
      ...
      className={clsx(
        "absolute top-[2rem] right-[3rem] w-9 h-9 2xl:w-10 2xl:h-10 t-xs:top-[31rem]",
    ...
    >
      <IconComponent
        name="winter"
        className={clsx(
          "first:dark:[&>*]:stroke-icon-on-primary first:[&>path]:stroke-icon-accent block absolute top-0 left-0 w-9 2xl:w-10 ",
