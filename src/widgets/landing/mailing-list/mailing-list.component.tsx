...
export const MailingList = () => {
  ...
  return (
    <div className="rounded-xl mb-[8.75rem] bg-mailing-list-bg-light dark:bg-mailing-list-bg mx-[5rem] p-[3.375rem] mt-[5.25rem] m-md:mx-[1.125rem] m-md:px-4 m-md:py-7">
