...
export const AllCasesButton: React.FC<AllCasesButton> = ({ className }) => {
    return (
        <Link href={'/cases/'} className={`text-[inherit] ${className}`}>
        <div className="flex items-center bg-[white] dark:bg-dark-bg-secondary h-20 w-64 t-xs:w-48 t-xs:h-16
         rounded-full t-xs:mt-0 mt-132 cursor-pointer">
          <span className="text-2xl font-medium leading-8 ml-10 t-xs:ml-8 t-xs:text-base">Все кейсы</span>
