    ...
    <div className="container py-8 md:py-16">
      <div className="relative h-0 pt-[56.25%] overflow-hidden rounded-xl">
        ...
        <div
          ...
          className={clsx(
            "absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-10 h-10 text-light-bg-accent bg-text-bg-gradient dark:text-bg-gradient dark:bg-light-bg-accent rounded-full flex items-center justify-center cursor-pointer transition-all hover:scale-105 md:w-20 md:h-20",
