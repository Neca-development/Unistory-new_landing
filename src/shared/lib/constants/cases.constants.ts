				...
				text: [
					{
						...
						text: "Разработать мобильное приложение для iOS и Android, <br /> а также веб-версию, которая будет работать на всех устройствах. Приложение должно быть мультиплатформенным, а также иметь интеграцию с популярными платформами для поиска работы.",
					},
				],
				banner:
					"https://www.parkwoodtheatres.co.uk/.imaging/focalpoint/2576x1442/dam/jcr:50bd2304-a999-4204-b375-68fe42362925/Hazlitt+Shrek+Banner+%281%29.png",
