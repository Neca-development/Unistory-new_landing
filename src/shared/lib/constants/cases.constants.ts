...
export const CASES: ICase[] = [
...

	{
		...
		categories: {
			...
			ru: [
				"Создание геймифицированной NFT коллекции",
			],
		},
		showCategoriesOnPage: false,
...

	{
		...
		categories: {
			en: [
				"P2E game based on NFT collection",
			],
			ru: [
				"P2E игра на базе NFT коллекции",
			],
		},
		showCategoriesOnPage: false,
		icons: ["monitor", "bitcoin"],
...

	{
		...
		categories: {
			en: [
				"Development of a platform for VoIP provider",
			],
			ru: [
				"Разработка платформы для VoIP провайдера ",
			],
		},
		showCategoriesOnPage: false,
	...
	},
	{
		...
		categories: {
			en: ["Development of Charity Platform"],
			ru: [
				"Благотварительная платформа Адрес.Люди",
			],
		},
		showCategoriesOnPage: false,
		icons: ["monitor", "phone02"],
	...
	},
	{
		...
		categories: {
			en: [
				"HoarderNest –innovative NFT aggregator",
			],
			ru: [
				"HoarderNest – инновационный NFT агрегатор",
			],
		},
		description: {
