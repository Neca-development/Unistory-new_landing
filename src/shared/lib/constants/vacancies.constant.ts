...
export const VACANCIES: IVacancy[] = [
  {
    ...
    description: {
      ...
      ru: [
        "Количество проектов растет, и мы активно расширяем команду разработки. На данный момент нам нужен Frontend Developer.",
  ...
  },
  {
    ...
    description: {
      en: [],
      ru: [
        "Количество проектов растет, и мы активно расширяем команду разработки. На данный момент нам нужен Junior Дизайнер.",
      ],
    },
    jobPoints: {
      en: [],
      ru: [
        {
          ...
          listItems: [
            ...
            "Структурировать своё рабочее время, попадать в дедлайны поставленных задачах или вовремя предупреждает об изменениях.",
          ],
        },
        {
          title: "Для успешной работы у нас вам необходимы:",
  ...
  },
  {
    ...
    jobPoints: {
      ...
      ru: [
        ...
        {
          title: "Откликайтесь, если вы:",
          listItems: [
            "Имеете опыт коммерческой разработки от полугода или собственные pet-проекты.",
            "Понимаете принципы ООП и SOLID.",
            "Имеете опыт работы с typeORM и PostgresQL.",
            "Уверенно владеете Nest.js, Typescipt.",
            "Владеете английским языком на уровне, достаточном для чтения технической документации.",
            "И самое важное — умеете и хотите работать в команде :)",
          ],
        },
        {
          title: "Будет плюсом при рассмотрении:",
