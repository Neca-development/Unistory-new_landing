...
export const BitGraduate = (props: IBitGraduateProperties) => {
  ...
  return (
    <>
      ...
      >
        <div className="container relative z-10 mt-28 flex h-[70%] items-center justify-between">
          <motion.div
          ...
          <motion.div
            className="flex w-1/2 flex-col justify-between gap-[5rem] text-[3rem] text-bg-gradient"
            initial={{
              opacity: 0,
          ...
          <motion.div
            className="relative aspect-[5/3] w-1/2"
            initial={{
              opacity: 0,
              transform: 'translateY(200%)',
            }}
